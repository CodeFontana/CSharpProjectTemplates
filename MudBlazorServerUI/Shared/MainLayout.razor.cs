...
public partial class MainLayout
{
    ...
    private MudTheme lightTheme = new()
    {
        ...
        Typography = new()
        {
            Default = new()
            {
                FontFamily = new[] { "system-ui", "-apple-system", "Segoe UI", "Helvetica Neue", "Nioti Sans", "Liberation Sans", "Arial", "sans-serif" },
            }
        },
        Palette = new()
        {
