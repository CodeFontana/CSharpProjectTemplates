...
Simple, configurable and extensible.  No more maintaining your own proprietary logger when, in reality, that is not the main focus of your project.  Serilog integrates perfectly with the .NET Generic Host provider across all the starter templates, less the Blazor WASM template of course!
